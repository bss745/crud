...
class Product {
  ...
  static getRandomList = (id) => {
    // Фільтруємо товари, щоб вилучити той, з яким порювнюємо ID
    const filteredList = this.#list.filter(
      (product) => product.id !== id,
    )

    // Відсортовуємо товари за допомогою Math.random() та перемішаємо масив
...
Product.add(
  'https://picsum.photos/200/300',
  `Комп'ютер Proline Business (b112p19) Intel Core 15 9400F/`,
...
Product.add(
  'https://picsum.photos/200/300',
  `Комп'ютер Proline Workstation (x67p03) Intel Xeon E-2226G/`,
  `Intel Xeon E-2226G (3.4 - 4.7 ГГц) / RAM 16 ГБ / SSD 512 ГБ / nVidia Quattro P620, 2 ГБ`,
